 ...
 * والتسمية المعروضة هي **الرمز نفسه**: «الفصل التدريبي 144710».
 *
 * ولا تُشتق منه سنة هجرية معروضة: الأربع الأولى سنةُ بدء العام الدراسي
 * (١٤٤٧/١٤٤٨)، فكتابة «١٤٤٧هـ» وحدها تُخالف السنة الجارية فعلاً وهي
 * ١٤٤٨ — قرار المالك ٢٠٢٦-٠٨-٢٠. الجزء والسنة يبقيان في `partLabel`
 * و`year` لمن احتاجهما، ولا يدخلان النص المعروض.
 *
...
export interface TermInfo {
  ...
  year: string;
  part: TermPart;
  /** «الفصل التدريبي 144710» — الرمز كما هو. */
  label: string;
