 ...
 *
 * **غير موصول بمسارٍ حالياً**: مدخل المدرب صار `#/home` بعد دخوله بحزمة
 * الفصل المعمّاة، ورفع تقرير رايات واختيار المدرب عملُ أدمنٍ مكانه صفحة
 * `#/admin` التي لم تُبنَ بعد. يبقى هذا الملف أساساً لها.
 *
 * فهرس المقررات مع لوحة المدربين:
